return {
    ...
    localizationCatalogs = require("minimal-content-pack.localization_catalogs"),
    localization = require("minimal-content-pack.localization_keys"),
    manifest = require("minimal-content-pack.manifest"),
